...
- **Native core** (`src/native`) — OCCT-free C++20: `math` (vectors/transforms +
  ...
  0 near-tangent-truncated, onSurf ≤ 6.81e-07; near-tangent / coincident robustness is
  the pending S4 moat, curved booleans consuming these WLines the pending S5 payoff), and `numerics`
