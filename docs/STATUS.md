...
|---|---|---|
| Host unit tests (CPU-only, stub + native core) | `ctest` (host build) | **28 / 28** (**35** with `CYBERCAD_HAS_NUMSCI=ON`) — incl. `test_native_heal` |
