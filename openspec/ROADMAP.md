...
| 4b | `add-native-swept-solids` (Tier E) | native-construction (advanced) | ☐ follow-up — E wrap-emboss (+ 3+-section / guided / rail loft, non-planar / guided / rail sweep, `cc_helical_thread` / `cc_tapered_thread` robust-watertight thread mesh), currently OCCT-fallthrough |
