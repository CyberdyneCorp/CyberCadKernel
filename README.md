...
cmake --build build
cd build && ctest --output-on-failure          # -> 28/28 pass (incl. native math/topology/tessellate/construct/profile/residuals/loft/sweep/thread/boolean (planar + curved box-cylinder)/blend/step/engine/ssi/ssi-s4-classification/heal)
```
