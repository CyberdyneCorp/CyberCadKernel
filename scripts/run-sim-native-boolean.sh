#!/usr/bin/env bash
# Compile the native-vs-OCCT BOOLEAN parity harness for the iOS simulator and run it
...
HARNESS="$REPO/tests/sim/native_boolean_parity.mm"
...
xcrun simctl spawn "$UDID" "$OUT/native_boolean_parity"
