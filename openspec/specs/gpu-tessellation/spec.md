# gpu-tessellation Specification

## Purpose
TBD - synced from change add-gpu-tessellation (not archived; deferred tasks remain). Update Purpose when the change is archived.
## Requirements
