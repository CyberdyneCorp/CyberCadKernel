#!/usr/bin/env bash
# Compile the MOAT M-DM DM3 (general offset/tilt retarget) + DM4 (point projection)
...
HARNESS="$REPO/tests/sim/native_dm3_dm4_parity.mm"
...
echo "── compiling DM3/DM4 native-vs-OCCT parity harness (iphonesimulator arm64)"
...
xcrun simctl spawn "$UDID" "$OUT/native_dm3_dm4_parity"
