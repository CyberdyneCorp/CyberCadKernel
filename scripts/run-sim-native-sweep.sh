#!/usr/bin/env bash
# Compile the native-vs-OCCT SWEPT-solid parity harness (Tier C, Phase 4
...
HARNESS="$REPO/tests/sim/native_sweep_parity.mm"
...
xcrun simctl spawn "$UDID" "$OUT/native_sweep_parity"
