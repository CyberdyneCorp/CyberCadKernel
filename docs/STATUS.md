...
| SSI **S5-a/b/c/d/e** curved boolean vs OCCT `BRepAlgoAPI` | `scripts/run-sim-native-ssi-curved-boolean.sh` | **21 / 21** (native-pass=15: drill cyl∩cyl COMMON/FUSE/CUT + **sphere∩sphere COMMON/FUSE/CUT eq+uneq (op-set COMPLETE 3/3, FUSE ΔV ≤ 8.3e-4 / CUT ΔV ≤ 9.3e-4 vs analytic+OCCT)** + **branched Steinmetz COMMON/FUSE/CUT** (`16R³/3`+incl-excl + OCCT, ΔV ≤ 8.75e-4) + **coaxial cone∩cylinder COMMON/FUSE/CUT (op-set COMPLETE 3/3)** (CONE family; dual oracle `V_frustum` inclusion-exclusion + OCCT — COMMON volN=19.107/volO=19.111 ΔV=2.03e-4 ΔA=9.89e-5, FUSE volN=41.618/volO=41.626 (analytic 41.62610) ΔV=2.04e-4 ΔA=1.13e-4, CUT volN=13.349/volO=13.352 (analytic 13.35177) ΔV=2.03e-4 ΔA=1.02e-4), all wt, ΔV ≤ 9e-4; 6 honest fallbacks incl. sphere×box, cone×box) |
