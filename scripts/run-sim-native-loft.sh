#!/usr/bin/env bash
# Compile the native-vs-OCCT RULED-loft parity harness (Tier B, Phase 4
...
HARNESS="$REPO/tests/sim/native_loft_parity.mm"
...
xcrun simctl spawn "$UDID" "$OUT/native_loft_parity"
