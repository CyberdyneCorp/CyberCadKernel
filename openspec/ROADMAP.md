...
| 4b | `add-native-swept-solids` (Tiers B–E) | native-construction (advanced) | ☐ follow-up — B loft / C sweep+twisted/guided/rail / D threads / E wrap-emboss, currently OCCT-fallthrough |
