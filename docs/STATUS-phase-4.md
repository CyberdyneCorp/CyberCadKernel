...
### Deferred to S4-d…f / later (recorded, not blocking the S4-a/b/c bar)
- **S4-d** — branch points (splitting the trace where branches meet/cross — e.g. the
  equal-cylinder saddle; S4-c's crossable gate detects and DEFERS these, never crosses them).
