...
| SSI **S5-a/b/c/d/e** curved boolean vs OCCT `BRepAlgoAPI` | `scripts/run-sim-native-ssi-curved-boolean.sh` | **21 / 21** (native-pass=13: drill cyl∩cyl COMMON/FUSE/CUT + **sphere∩sphere COMMON/FUSE/CUT eq+uneq (op-set COMPLETE 3/3, FUSE ΔV ≤ 8.3e-4 / CUT ΔV ≤ 9.3e-4 vs analytic+OCCT)** + **branched Steinmetz COMMON/FUSE/CUT** (`16R³/3`+incl-excl + OCCT, ΔV ≤ 8.75e-4) + **coaxial cone∩cylinder COMMON** (CONE family opened; dual oracle `V_frustum` closed form 19.111355 + OCCT 19.111, volN=19.107, ΔV=2.03e-4, ΔA=9.89e-5), all wt, ΔV ≤ 9e-4; 8 honest fallbacks incl. sphere×box, cone×box, cone∩cyl FUSE/CUT) |
