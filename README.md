...
- **Native core** (`src/native`) — OCCT-free C++20: `math` (vectors/transforms +
  ...
  the deeper **S4-d general/freeform + S4-e general/freeform + S4-f marching core**
  (general/freeform branch points, higher-order/curve cusps, general/freeform parametric
  singularities, self-intersection completeness, deeper near-coincident bands) is the
