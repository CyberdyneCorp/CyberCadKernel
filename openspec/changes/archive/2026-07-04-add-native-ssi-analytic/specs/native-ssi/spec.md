...
Native, OCCT-free, closed-form surface-surface intersection — **SSI Stage S1** of
`openspec/SSI-ROADMAP.md`. Internal capability: **no `cc_*` ABI**. This is the
first SSI stage and the on-ramp to curved booleans (S5).
