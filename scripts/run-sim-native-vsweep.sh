#!/usr/bin/env bash
# Compile the native-vs-OCCT VARIABLE-SECTION sweep parity harness (moat-vsweep, Phase 4
...
HARNESS="$REPO/tests/sim/native_vsweep_parity.mm"
...
echo "── compiling native-vsweep parity harness for iphonesimulator (arm64)"
...
xcrun simctl spawn "$UDID" "$OUT/native_vsweep_parity"
